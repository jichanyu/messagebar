...
/**
 * <p>标题：页面请求工具类</p>
 * <p>功能：设置获取session,requset</p>
 * <p>版权： Copyright © 2015 IKCAI</p>
 * <p>公司： 一棵菜</p>
 * <p>创建日期：2015年12月3日 下午10:56:44</p>
 * <p>类全名：com.ikcai.util.RequestUtil</p>
 * 作者：赵力
 * @version 1.0
 */
public class RequestUtil
{
	...
	public static final String	LAST_PAGE		= "com.ikcai.lastPage";
	...
	public static String getRealIP(final HttpServletRequest request)
	{
		...
		if (!StrUtil.isStrTrimNull(ip) && !"unknown".equalsIgnoreCase(ip))
